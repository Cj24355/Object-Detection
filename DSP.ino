...
{
  // Set the bottleDetected variable to true
  bottleDetected = true;
  server.send(200, "text/plain", "Bottle detected");
}
...
void setup()
{
  ...
  // Add a new route to handle the notification
  server.on("/bottle-detected", handleBottleDetected);
